...
print("\nCongratulations you have the  Tic-Tac-Toe Game !..............")
print("______________")
...
leaveLoop = False
turnCounter = int(input("\nTo start the game Choose '1' to go first or '0'to go Second " ))

def declaration():
    winner = Check_for_Winner(gameBoard)
    if winner is not None:
        printgameBoard()
        print(f"{winner} Wins!Game Finished ")
        return True
    elif not possibleNumbers:  # Check for tie
        printgameBoard()
        print("The match is a Tie. Game Finished....")
        return True
    return False
